...
var particleColors = [
  new liquidfun.b2ParticleColor(0xff, 0x00, 0x00, 0xff), // red
  new liquidfun.b2ParticleColor(0x00, 0xff, 0x00, 0xff), // green
  new liquidfun.b2ParticleColor(0x00, 0x00, 0xff, 0xff), // blue
  new liquidfun.b2ParticleColor(0xff, 0x8c, 0x00, 0xff), // orange
  new liquidfun.b2ParticleColor(0x00, 0xce, 0xd1, 0xff), // turquoise
  new liquidfun.b2ParticleColor(0xff, 0x00, 0xff, 0xff), // magenta
  new liquidfun.b2ParticleColor(0xff, 0xd7, 0x00, 0xff), // gold
  new liquidfun.b2ParticleColor(0x00, 0xff, 0xff, 0xff) // cyan
];
var container;
var world = null;
var threeRenderer;
...
function initTestbed() {
  ...
  var gravity = new liquidfun.b2Vec2(0, -10);
  world = new liquidfun.b2World(gravity);
  Testbed();
}

function testSwitch(testName) {
  ResetWorld();
  world.SetGravity(new liquidfun.b2Vec2(0, -10));
...
QueryCallback.prototype.ReportFixture = function(fixture) {
  ...
  if (body.GetType() === liquidfun.b2_dynamicBody) {
...
function getMouseCoords(event) {
  ...
  var p = new liquidfun.b2Vec2(pos.x, pos.y);
  return p;
}
